...
def process_image(image_path, model_path, params, output_folder):
    ...
    if results[0].keypoints is not None and len(results[0].keypoints.data) > 0:
        ...
        return annotated_img_path, visualization_path, excel_path, pdf_path
    else:
...
output_folder = st.text_input("Enter output folder", value=r"C:\Users\220250572\OneDrive - Regal Rexnord\Desktop\Ergonmics\output")
...
if uploaded_image and submitted:
    ...
    annotated_img_path, visualization_path, excel_path, pdf_path = process_image(
