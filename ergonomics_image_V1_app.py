...
if submitted:
    if uploaded_image:
        ...
        annotated_img_path, visualization_path, excel_path, pdf_path, reba_result, rula_result, niosh_result = process_image(
        ...
        if annotated_img_path:
            ...
            # ✅ Display REBA, RULA, NIOSH results
